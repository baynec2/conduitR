...
conduitR::log_with_timestamp("Running 02_extract_go_info.R script")
...
end_time <- Sys.time()
conduitR::log_with_timestamp("Completed 02_extract_go_info.R script. Time taken: %.2f minutes", 
