...
conduitR::log_with_timestamp("Running 04_process_diann_matrices.R script")
...
conduitR::log_with_timestamp(paste0("Copying report_pg_matrix to ", protein_group_matrix))
file.copy(report_pg_matrix,protein_group_matrix)

end_time <- Sys.time()
conduitR::log_with_timestamp("Completed 04_process_diann_matrices.R script. Time taken: %.2f minutes", 
